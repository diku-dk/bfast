...
int64_t *futhark_shape_f32_3d(struct futhark_context *ctx,
                              struct futhark_f32_3d *arr);
struct futhark_i16_3d ;
struct futhark_i16_3d *futhark_new_i16_3d(struct futhark_context *ctx,
                                          int16_t *data, int64_t dim0,
                                          int64_t dim1, int64_t dim2);
struct futhark_i16_3d *futhark_new_raw_i16_3d(struct futhark_context *ctx,
                                              char *data, int offset,
                                              int64_t dim0, int64_t dim1,
                                              int64_t dim2);
int futhark_free_i16_3d(struct futhark_context *ctx,
                        struct futhark_i16_3d *arr);
int futhark_values_i16_3d(struct futhark_context *ctx,
                          struct futhark_i16_3d *arr, int16_t *data);
char *futhark_values_raw_i16_3d(struct futhark_context *ctx,
                                struct futhark_i16_3d *arr);
int64_t *futhark_shape_i16_3d(struct futhark_context *ctx,
                              struct futhark_i16_3d *arr);
...
int futhark_entry_remove_nans(struct futhark_context *ctx,
                              struct futhark_f32_3d **out0, const int16_t in0,
                              const struct futhark_i16_3d *in1);
...
static void futrts_cli_entry_remove_nans(struct futhark_context *ctx)
{
    ...
    int16_t read_value_4198;
    
    if (read_scalar(&i16_info, &read_value_4198) != 0)
        panic(1, "Error when reading input #%d of type %s (errno: %s).\n", 0,
              i16_info.type_name, strerror(errno));
    
    struct futhark_i16_3d *read_value_4199;
    int64_t read_shape_4200[3];
    int16_t *read_arr_4201 = NULL;
    
    errno = 0;
    if (read_array(&i16_info, (void **) &read_arr_4201, read_shape_4200, 3) !=
        0)
        panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 1,
              "[][][]", i16_info.type_name, strerror(errno));
    
    struct futhark_f32_3d *result_4202;
    ...
    if (perform_warmup) {
        ...
        ;
        assert((read_value_4199 = futhark_new_i16_3d(ctx, read_arr_4201,
                                                     read_shape_4200[0],
                                                     read_shape_4200[1],
                                                     read_shape_4200[2])) != 0);
        assert(futhark_context_sync(ctx) == 0);
        t_start = get_wall_time();
        r = futhark_entry_remove_nans(ctx, &result_4202, read_value_4198,
                                      read_value_4199);
        if (r != 0)
        ...
        ;
        assert(futhark_free_i16_3d(ctx, read_value_4199) == 0);
        assert(futhark_free_f32_3d(ctx, result_4202) == 0);
    }
    time_runs = 1;
    /* Proper run. */
        ...
        set_binary_mode(stdout);
    {
        float *arr = calloc(sizeof(float), futhark_shape_f32_3d(ctx,
                                                                result_4202)[0] *
                            futhark_shape_f32_3d(ctx, result_4202)[1] *
                            futhark_shape_f32_3d(ctx, result_4202)[2]);
        
        assert(arr != NULL);
        assert(futhark_values_f32_3d(ctx, result_4202, arr) == 0);
        write_array(stdout, binary_output, &f32_info, arr,
                    futhark_shape_f32_3d(ctx, result_4202), 3);
        free(arr);
    }
    printf("\n");
    assert(futhark_free_f32_3d(ctx, result_4202) == 0);
...
int main(int argc, char **argv)
{
    ...
    struct entry_point_entry entry_points[] = {{.name ="remove_nans", .fun =
                                                futrts_cli_entry_remove_nans}};
...
static int futrts_remove_nans(struct futhark_context *ctx,
                              struct memblock *out_mem_p_4194,
                              int32_t *out_out_arrsizze_4195,
                              int32_t *out_out_arrsizze_4196,
                              int32_t *out_out_arrsizze_4197,
                              struct memblock images_mem_4147,
                              int32_t sizze_4099, int32_t sizze_4100,
                              int32_t sizze_4101, int16_t nan_value_4102);
...
static int futrts_remove_nans(struct futhark_context *ctx,
                              ...
                              int32_t sizze_4101, int16_t nan_value_4102)
{
    struct memblock out_mem_4187;
    
    out_mem_4187.references = NULL;
    
    int32_t out_arrsizze_4188;
    int32_t out_arrsizze_4189;
    int32_t out_arrsizze_4190;
    int32_t binop_x_4149 = sizze_4099 * sizze_4100;
    int32_t convop_x_4150 = sizze_4101 * binop_x_4149;
    int64_t binop_x_4151 = sext_i32_i64(convop_x_4150);
    int64_t bytes_4148 = 4 * binop_x_4151;
    struct memblock mem_4152;
    
    mem_4152.references = NULL;
    if (memblock_alloc(ctx, &mem_4152, bytes_4148, "mem_4152"))
        return 1;
    for (int32_t i_4123 = 0; i_4123 < sizze_4099; i_4123++) {
        for (int32_t i_4119 = 0; i_4119 < sizze_4100; i_4119++) {
            for (int32_t i_4115 = 0; i_4115 < sizze_4101; i_4115++) {
                int16_t x_4109 = *(int16_t *) &images_mem_4147.mem[(i_4123 *
                                                                    (sizze_4101 *
                                                                     sizze_4100) +
                                                                    i_4119 *
                                                                    sizze_4101 +
                                                                    i_4115) *
                                                                   2];
                bool cond_4110 = x_4109 == nan_value_4102;
                float res_4111;
                
                if (cond_4110) {
                    res_4111 = NAN;
                } else {
                    float res_4112 = sitofp_i16_f32(x_4109);
                    
                    res_4111 = res_4112;
                }
                *(float *) &mem_4152.mem[(i_4123 * (sizze_4101 * sizze_4100) +
                                          i_4119 * sizze_4101 + i_4115) * 4] =
                    res_4111;
            }
        }
    }
    out_arrsizze_4188 = sizze_4099;
    out_arrsizze_4189 = sizze_4100;
    out_arrsizze_4190 = sizze_4101;
    if (memblock_set(ctx, &out_mem_4187, &mem_4152, "mem_4152") != 0)
        return 1;
    (*out_mem_p_4194).references = NULL;
    if (memblock_set(ctx, &*out_mem_p_4194, &out_mem_4187, "out_mem_4187") != 0)
        return 1;
    *out_out_arrsizze_4195 = out_arrsizze_4188;
    *out_out_arrsizze_4196 = out_arrsizze_4189;
    *out_out_arrsizze_4197 = out_arrsizze_4190;
    if (memblock_unref(ctx, &mem_4152, "mem_4152") != 0)
        return 1;
    if (memblock_unref(ctx, &out_mem_4187, "out_mem_4187") != 0)
        return 1;
    return 0;
}
struct futhark_f32_3d {
...
struct futhark_i16_3d *futhark_new_i16_3d(struct futhark_context *ctx,
                                          ...
                                          int64_t dim1, int64_t dim2)
{
    struct futhark_i16_3d *bad = NULL;
    struct futhark_i16_3d *arr = malloc(sizeof(struct futhark_i16_3d));
    
    if (arr == NULL)
        return bad;
    lock_lock(&ctx->lock);
    arr->mem.references = NULL;
    if (memblock_alloc(ctx, &arr->mem, dim0 * dim1 * dim2 * sizeof(int16_t),
                       "arr->mem"))
        return NULL;
    arr->shape[0] = dim0;
    arr->shape[1] = dim1;
    arr->shape[2] = dim2;
    memmove(arr->mem.mem + 0, data + 0, dim0 * dim1 * dim2 * sizeof(int16_t));
    lock_unlock(&ctx->lock);
    return arr;
}
struct futhark_i16_3d *futhark_new_raw_i16_3d(struct futhark_context *ctx,
...
int futhark_free_i16_3d(struct futhark_context *ctx, struct futhark_i16_3d *arr)
{
    lock_lock(&ctx->lock);
    if (memblock_unref(ctx, &arr->mem, "arr->mem") != 0)
        return 1;
                              ...
                              const struct futhark_i16_3d *in1)
{
    ...
    images_mem_4147.references = NULL;
    
    int32_t sizze_4099;
    int32_t sizze_4100;
    int32_t sizze_4101;
    int16_t nan_value_4102;
    struct memblock out_mem_4187;
    ...
    lock_lock(&ctx->lock);
    nan_value_4102 = in0;
    images_mem_4147 = in1->mem;
    sizze_4099 = in1->shape[0];
    sizze_4100 = in1->shape[1];
    sizze_4101 = in1->shape[2];
    
    int ret = futrts_remove_nans(ctx, &out_mem_4187, &out_arrsizze_4188,
                                 &out_arrsizze_4189, &out_arrsizze_4190,
                                 images_mem_4147, sizze_4099, sizze_4100,
                                 sizze_4101, nan_value_4102);
    
    if (ret == 0) {
        assert((*out0 = malloc(sizeof(struct futhark_f32_3d))) != NULL);
        (*out0)->mem = out_mem_4187;
        (*out0)->shape[0] = out_arrsizze_4188;
        (*out0)->shape[1] = out_arrsizze_4189;
        (*out0)->shape[2] = out_arrsizze_4190;
    }
    lock_unlock(&ctx->lock);
    return ret;
}
