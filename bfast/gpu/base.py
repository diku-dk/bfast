...
from .bfastdistrib import bfastdistrib
from .bfastdistribdetailed import bfastdistribdetailed
    ...
    def __init__(self,
        ...
        if self.detailed_results:
            if self.old_version == False: 
                self.futobj = bfastfinaldetailed(command_queue=self.queue, 
                                                 interactive=False, 
                                                 default_tile_size=16)
            else:
                self.futobj = bfastdistribdetailed(command_queue=self.queue,
                                                   interactive=False, 
                                                   default_tile_size=16)                
        else:
            if self.old_version == False:
                ...
                self.futobj = bfastdistrib(command_queue=self.queue,
                                           interactive=False, 
                                           default_tile_size=16)                
